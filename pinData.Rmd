...
WQM_Stations_SpatialCounty <- #filter(WQM_Stations_Spatial1, is.na(US_L3CODE)) %>%
  st_intersection(WQM_Stations_Spatial1, dplyr::select(county, CountyCityName = NAME, FIPS)) %>%st_drop_geometry()
